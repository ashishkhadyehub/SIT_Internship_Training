<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="EMP.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <asp:Button runat="server" OnClick="btnSave_Click" OnClientClick="return valid()" ID="btnSave" Text="Register" CssClass="btn btn-primary" />
